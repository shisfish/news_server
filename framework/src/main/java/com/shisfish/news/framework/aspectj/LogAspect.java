...
import com.shisfish.news.common.lang.enums.BusinessStatus;
import com.shisfish.news.common.lang.enums.HttpMethod;
...
public class LogAspect {
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(com.shisfish.news.common.lang.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            if (e != null) {
                // 操作状态（0正常 1异常）
                operLog.setStatus(BusinessStatus.FAILL.ordinal());
                // 错误消息
