...
public class ClassUtil {
    ...
    static {
        ...
        ClassUtil.PRIMITIVE_WRAPPER_TYPE_MAP.put(Byte.class, Byte.TYPE);
        ClassUtil.PRIMITIVE_WRAPPER_TYPE_MAP.put(Character.class, Character.TYPE);
        ClassUtil.PRIMITIVE_WRAPPER_TYPE_MAP.put(Double.class, Double.TYPE);
        ClassUtil.PRIMITIVE_WRAPPER_TYPE_MAP.put(Float.class, Float.TYPE);
        ClassUtil.PRIMITIVE_WRAPPER_TYPE_MAP.put(Integer.class, Integer.TYPE);
        ClassUtil.PRIMITIVE_WRAPPER_TYPE_MAP.put(Long.class, Long.TYPE);
        ClassUtil.PRIMITIVE_WRAPPER_TYPE_MAP.put(Short.class, Short.TYPE);
    }
    ...
    private static void wrapClassses(Class<?>[] source) {
        for (int i = 0; i < source.length; i++) {
            Class<?> wrapClass = PRIMITIVE_WRAPPER_TYPE_MAP.get(source[i]);
            if (wrapClass != null) {
                source[i] = wrapClass;
            }
        }
